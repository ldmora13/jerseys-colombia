...
const F1 = ({ cartVisible, setCartVisible }) => {
    ...
    const seoData = {
        ...
        keywords: 'jerseys f1, jerseys de Formula 1, camisetas f1, Ferrari, Mercedes, Red Bull Racing, Aston Martin, McLaren, Williams, Haas, Sauber, RB, Alpine, jerseys colombia, f1, formula 1, Charles Leclerc, Lewis Hamilton, Max Verstappen, Fernando Alonso',
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
            ...
            {/* Hero Section */}
            <div ref={topRef} className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 pt-24 pb-16">
                <div className="container mx-auto px-4 mt-5">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">
                            Jerseys de Fórmula 1 Originales
                        </h1>
                        <p className="text-xl md:text-2xl mb-8 text-purple-100">
                            +{camisetasFiltradas.length} productos de los mejores equipos del mundo
                        </p>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8 bg-white/95 backdrop-blur-xl rounded-2xl p-4 shadow-lg border border-white/20">
                    <button
                        ...
                        className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 shadow-lg"
                    >
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <select
                            ...
                            className="flex-1 md:flex-initial px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300"
                        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-12">
                    {camisetasPagina.map((camiseta, index) => {
                        ...
                        return (
                            ...
                            >
                                <Link to={`/${categoria.toLowerCase()}/${slug}`} className="block">
                                    <div className="relative h-[280px] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                                        {imagenPrincipal && (
                                            <img
                                                src={imagenPrincipal}
                                                alt={camiseta.name}
                                                className="w-full h-full object-contain absolute top-0 left-0 opacity-100 group-hover:opacity-0 transition-opacity duration-500 p-4"
                                            />
                                        )}
                                        {imagenSecundaria && (
                                            <img
                                                ...
                                                className="w-full h-full object-contain absolute top-0 left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 p-4"
                                            />
                                        )}
                                ...
                                <div className="p-4">
                                    <Link to={`/${categoria.toLowerCase()}/${slug}`}>
                                        <h3 className="font-bold text-gray-800 mb-2 line-clamp-2 hover:text-purple-600 transition-colors capitalize">
                                            {camiseta.type} de {camiseta.team} {camiseta.year} {camiseta.driver}
                                        </h3>
                                    </Link>

                                    <div className="flex items-baseline gap-2 mb-3">
                                        <p className="text-2xl font-bold text-purple-600">${camiseta.price}</p>
                                    ...
                                    <select
                                        ...
                                        className="w-full mb-2 px-3 py-2 rounded-xl border-2 border-gray-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="w-full h-10 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition-all duration-300 shadow-lg hover:shadow-xl"
                                    >
                    ...
                    <div className="flex flex-col items-center gap-6 mb-12">
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="w-10 h-10 rounded-xl bg-white border-2 border-gray-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:border-purple-500 hover:text-purple-600 transition-all duration-300 shadow-lg"
                            >
                                            ...
                                            <button
                                                ...
                                                className={`w-10 h-10 rounded-xl font-semibold transition-all duration-300 ${
                                                    isCurrentPage
                                                        ...
                                                        : 'bg-white border-2 border-gray-200 text-gray-700 hover:border-purple-500 hover:text-purple-600 shadow-lg'
                                                }`}
                                            >
                                                {pageNumber}
                                            </button>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-3">
                                ...
                                ¿Por qué elegir nuestros productos de F1?
                            </h2>
                            <ul className="space-y-3">
                                {[
                                    "100% Poliéster de alta calidad",
                                    "Tela piqué de alta densidad",
                                    "Transpirable y resistente al lavado",
                                    "Logos bordados oficiales"
                                ].map((item, index) => (
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                Mercedes, Red Bull, Ferrari, McLaren, Alpine, Aston Martin, Williams, Alfa Romeo, Haas y más equipos de la Fórmula 1.
                            </p>
                            <p className="text-gray-700">
                                Encuentra productos de tus pilotos favoritos: Lewis Hamilton, Max Verstappen, Charles Leclerc, Fernando Alonso, Lando Norris y más.
                            </p>
                        </div>
                    </div>
                </div>
