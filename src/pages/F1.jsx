    ...
    const fetchCamisetasF1 = async () => {
      try {
        const f1Res = await supabase
          .from('f1')
          .select('name, img, team, year, index, driver, type, price, stock, category')
      ...
      <div className="flex-1">
        ...
        <main className="flex flex-col items-center w-full p-4 text-black">
          <div className='flex flex-col items-center w-auto h-auto'>
            <svg className='h-12' fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1" viewBox="0 0 512 512">
