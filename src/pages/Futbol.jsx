                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                Encuentra jerseys de los mejores equipos: Real Madrid, Barcelona, Manchester United, PSG, Liverpool, Bayern Munich, Juventus y muchos más.
                            </p>
                            <p className="text-gray-700">
                                Temporadas actuales y retro de ligas como La Liga, Premier League, Serie A, Bundesliga y Copa Libertadores.
                            </p>
                        </div>
                    </div>
                </div>
