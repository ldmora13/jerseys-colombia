                      ...
                      <div id="card2" className="w-full h-auto rounded-[25px] transition-all duration-200 hover:scale-[0.98] hover:rounded-[30px]">
                        ...
                        <form id="form" className="flex flex-col gap-6 p-6 bg-[#a4ceac] rounded-[25px]">
                          ...
                          <div className="flex items-center gap-3 bg-[#252525] p-3 rounded-[15px]">
                            ...
                            <input id="email" className="bg-transparent border-none outline-none w-full text-[#d3d3d3]" type="email" placeholder="Email" autoComplete="off"/>
                          </div>
                          ...
                          <div className="flex items-center gap-3 bg-[#252525] p-3 rounded-[15px]">
                            ...
                            <input id="password" className="bg-transparent border-none outline-none w-full text-[#d3d3d3]" type="password" placeholder="Password" autoComplete="off"/>
                          </div>

                          {/* Buttons */}
                          <div className="flex justify-around text-white">
                            <button id="btn-login" className="p-2 px-4 rounded-md bg-[#252525] hover:bg-black transition">
                              Iniciar sesión
                            </button>
                            <button
                              id="btn-google"
                              className="p-2 px-4 rounded-md bg-[#252525] text-white hover:bg-black transition">
